# coding: utf-8
# copy and changed from https://github.com/alibaba/tidevice.git
...
class DTXService(object):
    ...
    def recv_part_dtx_message(self):
        ...
        rawdata = self._conn.recv_exact(h.payload_length)
...
class ServiceInstruments(DTXService):
    ...
    def iter_application_notification(self):
        ...
        """
        channel_id = self.make_channel('com.apple.instruments.server.services.mobilenotifications')
...
if __name__ == '__main__':
    instrument = ServiceInstruments()
    print(instrument.system_info())
    print(instrument.app_launch("com.apple.AppStore"))
    print(instrument.network_information())
    print(instrument.hardware_information())
    print(instrument.app_list())
